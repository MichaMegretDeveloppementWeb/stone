    ...
    <div class="border-b border-border pb-8">
        ...
        <div class="mb-6 flex items-center gap-3 text-sm">
            ...
            <template v-else-if="!hasError">
                ...
                <div class="h-4 w-px bg-muted"></div>
                <span class="font-medium text-foreground">Créer un client</span>
            </template>
        </div>
            ...
            <div>
                <div class="mb-2 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <!-- Données réelles -->
                        <div v-else>
                            <h1 class="text-2xl font-bold tracking-tight text-foreground">Créer un client</h1>
                            <p class="text-sm text-muted-foreground">Nouveau client</p>
                        </div>
                    </div>
                </div>
