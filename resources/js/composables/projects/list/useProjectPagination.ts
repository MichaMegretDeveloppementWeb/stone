...
import type {
    ...
    PaginationState,
    PaginationActions,
} from '@/types/projects/list/pagination'
...
export function useProjectPagination(
    ...
    const updateMeta = (meta: PaginationMeta): void => {
        ...
        paginationState.currentPage = meta.current_page || 1
        paginationState.lastPage = meta.last_page || 1
        paginationState.perPage = meta.per_page || 15
        paginationState.total = meta.total || 0
        paginationState.hasNextPage = (meta.current_page || 1) < (meta.last_page || 1)
        paginationState.hasPrevPage = (meta.current_page || 1) > 1
    }
    ...
    // Actions supprimées - l'orchestrateur useProjectListManager gère la pagination via goToPage()
